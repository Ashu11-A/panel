...
import { Vite, VITE_PORT } from '@/libs/vite.js'
import { Terminal } from '@/controllers/terminal.js'
import fastify from 'fastify'
import { BaseEntity } from 'typeorm'
import { DatabaseConnection } from './controllers/database/index.js'
import { trySet, watcher } from '@/helpers.js'
import path from 'node:path'
import { readFile } from 'node:fs/promises'
import { Language } from '@/controllers/langs.js'
